# https://github.com/sekai-studio/starknet-libs/blob/bfc2d9a9354658fa79b64254817dc6ae8c4d9ed7/cairo_string/String.cairo
# Edited to use uint256 for str_id
...
@storage_var
func strings_str(str_id : Uint256, short_string_index : felt) -> (short_string : felt):
end

@storage_var
func strings_len(str_id : Uint256) -> (length : felt):
end
...
#
# Parameters:
#   str_id (Uint256): The ID of the string to return
#
# Returns:
...
func String_get{
        ...
        range_check_ptr}(str_id : Uint256) -> (str_len : felt, str : felt*):
    alloc_locals
    let (str) = alloc()
...
func _get_ss_loop{
        syscall_ptr : felt*, bitwise_ptr : BitwiseBuiltin*, pedersen_ptr : HashBuiltin*,
        range_check_ptr}(str_id : Uint256, ss_index : felt, ss_len : felt, str : felt*):
...
#
# Parameters:
#   str_id (Uint256): The ID of the string to store
#   str_len (felt): The length of the string
#   str (felt*): The string itself (in char array format)
#
func String_set{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        str_id : Uint256, str_len : felt, str : felt*):
    alloc_locals
...
func _set_ss_loop{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        str_id : Uint256, ss_index : felt, ss_len : felt, str : felt*):
...
func _set_ss_char_loop{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        str_id : Uint256, ss_felt_acc : felt, ss_position : felt, ss_len : felt, char_index : felt,
        str : felt*):
    if char_index == 0:
...
#
# Parameters:
#   str_id (Uint256): The ID of the string to delete
#
